...
RUN wget https://github.com/ImKTKota/Windows11React/archive/refs/heads/gh-pages.zip
...
# start app
ENTRYPOINT ["serve", "/usr/src/windows11/Windows11React-gh-pages", "-p", "3000", "-d", "--cors"]
